...
public class window {
	...
	private void initialize() {
		...
		rdbtnNewRadioButton.setBounds(632, 273, 141, 23);	//RADIO BUTTON PLACEMENT
		frame.getContentPane().add(rdbtnNewRadioButton);	//ADDS RADIO BUTTON
		
		/***************FAHRENHEIT RADIO BUTTON***************/
		
		JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("Fahrenheit ");
		rdbtnNewRadioButton_1.setForeground(new Color(230, 230, 250));
		rdbtnNewRadioButton_1.setBounds(632, 308, 141, 23);	//RADIO BUTTON PLACEMENT
		frame.getContentPane().add(rdbtnNewRadioButton_1);	//ADDS RADIO BUTTON
